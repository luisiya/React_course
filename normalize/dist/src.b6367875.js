...
},{"./ImmutableUtils":14}],15:[function(require,module,exports) {
'use strict';
...
},{"./ImmutableUtils":14}],10:[function(require,module,exports) {
'use strict';
...
},{"./Polymorphic":15}],11:[function(require,module,exports) {
'use strict';
...
},{"./Polymorphic":15}],12:[function(require,module,exports) {
'use strict';
...
},{"./Polymorphic":15}],13:[function(require,module,exports) {
'use strict';
...
},{"./ImmutableUtils":14}],8:[function(require,module,exports) {
'use strict';
...
},{"./schemas/Entity":9,"./schemas/Union":10,"./schemas/Values":11,"./schemas/Array":12,"./schemas/Object":13,"./schemas/ImmutableUtils":14}],4:[function(require,module,exports) {
"use strict";

var _normalizr = require("normalizr");

var data = [{ "id": "student-1",
    "name": "Mango",
    "courses": [{ "id": "course-1",
        "name": "Blockchain",
        "instructors": [{ "id": "instructor-1", "name": "Jack" }, { "id": "instructor-2", "name": "Ming" }] }, { "id": "course-2",
        "name": "AI",
        "instructors": [{ "id": "instructor-2", "name": "Ming" }, { "id": "instructor-3", "name": "Pam" }] }] }, { "id": "student-2",
    "name": "Poly",
    "courses": [{ "id": "course-2",
        "name": "AI",
        "instructors": [{ "id": "instructor-2", "name": "Ming" }, { "id": "instructor-3", "name": "Pam" }] }, { "id": "course-3",
        "name": "Machine Learning",
        "instructors": [{ "id": "instructor-1", "name": "Jack" }, { "id": "instructor-4", "name": "David" }] }] }, { "id": "student-3",
    "name": "Ajax",
    "courses": [{ "id": "course-1",
        "name": "Blockchain",
        "instructors": [{ "id": "instructor-1", "name": "Jack" }, { "id": "instructor-2", "name": "Ming" }] }, { "id": "course-3",
        "name": "Machine Learning",
        "instructors": [{ "id": "instructor-1", "name": "Jack" }, { "id": "instructor-4", "name": "David" }] }] }];

var instructorsSchema = new _normalizr.schema.Entity('instructors');

var coursesSchema = new _normalizr.schema.Entity('courses', {
    instructors: [instructorsSchema]
});
var studentsSchema = new _normalizr.schema.Entity('students', { courses: [coursesSchema]
});
var normalizeData = (0, _normalizr.normalize)(data, [studentsSchema]);
console.log(normalizeData);
},{"normalizr":8}],11:[function(require,module,exports) {
...
//# sourceMappingURL=/src.b6367875.map